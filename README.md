...
int main(void)
{
  ...
  Lcd_cursor(&lcd, 0,1);
  Lcd_string(&lcd, "Nithish R");
  Lcd_cursor(&lcd, 1,1);
  Lcd_string(&lcd, "212223040135");
...
<img width="1600" height="900" alt="WhatsApp Image 2026-08-21 at 9 07 32 AM" src="https://github.com/user-attachments/assets/0f8b4f0e-2d2d-431c-8cbf-e853659482e6" />


 
 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
 <img width="1130" height="873" alt="image" src="https://github.com/user-attachments/assets/c513ce9c-8612-43b6-b1b5-bdaa8829c2d7" />
